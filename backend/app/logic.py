        ...
        return {
            ...
            "clauses": [
                ...
                (
                    ...
                    f"ชำระวันนัดส่งมอบงาน โดยผู้รับจ้างจะแจ้งให้ผู้ว่าจ้างทราบล่วงหน้าเป็นลายลักษณ์อักษร "
                    f"ไม่น้อยกว่า 3 วัน งวดที่ 3 จำนวน {money(details.get('installment_3_amount'))} บาท "
                    f"ชำระวันส่งมอบงานครบถ้วน โดยผู้รับจ้างจะแจ้งให้ผู้ว่าจ้างทราบล่วงหน้าเป็นลายลักษณ์อักษร "
                    f"ไม่น้อยกว่า 3 วัน โดยชำระด้วยวิธีโอนเข้าบัญชีธนาคารชื่อ{g('bank_account_name')} "
                    f"ธนาคาร{g('bank_name')} เลขที่บัญชี {g('bank_account_number')}",
                ),
                (
                    3,
                    "ผู้รับจ้างสัญญาว่าจะจัดหาช่างฝีมือดี พร้อมควบคุมการทำงาน เพื่อทำเฟอร์นิเจอร์ตามแบบใน"
                    "เอกสารแนบท้ายสัญญาพร้อมติดตั้งจนกว่างานจะแล้วเสร็จ",
                ),
                (
                    4,
                    "งานตามสัญญานี้ไม่รวมงานแก้ไขความเสียหายความผิดพลาดจากการก่อสร้างของผู้ว่าจ้าง"
                    "หรือผู้รับเหมารายอื่นของผู้ว่าจ้าง",
                ),
                (
                    5,
                    f"ผู้รับจ้างสัญญาว่าจะทำงานที่ว่าจ้างให้แล้วเสร็จภายในประมาณ "
                    f"{g('work_duration_days') or '60-90'} วันหลังจากวันลงนามในสัญญาและทำการชำระเงินงวด"
                    f"แรกเรียบร้อยแล้ว โดยผู้ว่าจ้างตกลงจะเตรียมพื้นที่หน้างานให้อยู่ในสภาพเรียบร้อยพร้อมที่"
                    f"ผู้รับจ้างจะสามารถทำงานได้โดยไม่มีผู้รับเหมารายอื่นเข้าทำงานพร้อมกันในพื้นที่หน้างาน "
                    f"เป็นเวลาอย่างน้อย {g('prep_area_days') or '30'} วันก่อนครบกำหนดเวลาดำเนินงานดังกล่าว "
                    f"แต่ถ้าผู้รับจ้างทำงานไม่แล้วเสร็จตามกำหนดเวลาดังกล่าวโดยไม่ใช่ความผิดของผู้รับจ้าง "
                    f"ผู้รับจ้างไม่ต้องรับผิดต่อผู้ว่าจ้าง",
                ),
                (
                    6,
                    "ผู้รับจ้างจะรับผิดชอบต่อผู้ว่าจ้างในความเสียหายที่เกิดจากการทำงานของผู้รับจ้าง "
                    "รวมทั้งการกระทำของคนงาน ช่าง หรือบริวารของผู้รับจ้างในบริเวณที่ทำงานจ้างในสถานที่ของ"
                    "ผู้ว่าจ้าง เว้นแต่กรณีเกิดจากเหตุสุดวิสัย",
                ),
                (7, "หากมีหนี้เงินที่ผู้ว่าจ้างค้างชำระ ผู้ว่าจ้างตกลงเสียดอกเบี้ยให้แก่ผู้รับจ้างในอัตราร้อยละ 15 ต่อปี"),
                (
                    8,
                    "ผู้รับจ้างรับประกันผลงานเป็นระยะเวลา 1 ปี นับแต่วันส่งมอบงานโดยผู้รับจ้างจะรับผิดชอบแก้ไข"
                    "ซ่อมแซมเฟอร์นิเจอร์ที่ชำรุดเสียหายจากการผลิตหรือการติดตั้งของผู้รับจ้าง ด้วยค่าใช้จ่ายของ"
                    "ผู้รับจ้างเอง การรับประกันผลงานดังกล่าวไม่รวมรอยขีดข่วนหรือความเสียหายที่เกิดจากการใช้งาน"
                    "ในชีวิตประจำวันหรือเกิดจากการเคลื่อนย้ายของผู้ว่าจ้างหรือผู้อยู่อาศัยเองภายหลังจากการส่งมอบ"
                    "งาน และไม่รวมความเสียหายที่เกิดจากการใช้งานผิดวิธีหรือผิดวัตถุประสงค์ของเฟอร์นิเจอร์",
                ),
            ],
            "closing": (
                "สัญญานี้ทำขึ้นสองฉบับ มีข้อความตรงกันเก็บไว้ฝ่ายละฉบับ ทั้งสองฝ่ายได้อ่านและเข้าใจข้อความใน"
                "สัญญาแล้ว ถูกต้องตามความประสงค์ทุกประการ จึงลงชื่อไว้เป็นสำคัญต่อหน้าพยาน"
            ),
